...
<section style="position: relative;top: 150px;">
	<div class="container-fluid">
          ...
          <table class="table table-bordered text-center bg-light">
          	...
          	$data = "select * from diploma2 order by id desc";
          	...
          	<tr>
          		...
          		<td>
          			...
          			<a href="dipdelete.php?id=<?php echo $d['id']?>"><button class="btn btn-info">DELETE</button></a>
          			<a href="dipedit.php?id=<?php echo $d['id']?>"><button class="btn btn-info">EDIT/UPDATE</button></a>
