...
include "dbcon.php";
$id = $_GET['id'];
$data = "select * from engineering where id = '$id'";
...
<body style="background-image:url(image/libra.jpg); background-size: cover;">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8">
			 <form method="post" action="engiupdate.php" enctype="multipart/form-data">
					          <div class="mb-3">
					          ...
					          <div class="mb-3">
					          	<label style="color: white;">JEE Score</label>
					          	<input type="number" name="jee" value="<?php echo $e['jee'];  ?>" class="form-control">
					          </div>
