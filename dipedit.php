...
include "dbcon.php";
$id = $_GET['id'];
$data = "select * from diploma2 where id = '$id'";
...
<body style="background-image:url(image/libra.jpg); background-size: cover;">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8">
			 <form method="post" action="dipupdate.php" enctype="multipart/form-data">
					          <div class="mb-3">
					          ...
					          <div class="mb-3">
					          	<label style="color: white;">TENth Score</label>
					          	<input type="number" name="ten" value="<?php echo $e['ten'];  ?>" class="form-control">
					          </div>
